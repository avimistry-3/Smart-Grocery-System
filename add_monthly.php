...
<?php
	...
	if(isset($_POST['sub1']))
	{
		...
		{		
			...
			$a6=$dat2->us_id;
			$a7=$dat2->us_name;
			$sql="INSERT INTO  monthly(gr_id,gr_name,gr_price,gr_quant,quantity,us_id,us_name,ven_id,ven_name,date) VALUES ('". $a1 ."','". $a2 ."','". $a3 ."','". $a4 ."','". $a5 ."','". $a6 ."','". $a7 ."','". $a8 ."','". $a9 ."','".$dt."')";
			$obj=$cnc->query($sql);
			if($obj)
				{
				?>
					<script type="text/javascript">
						alert('Added');
						window.location.assign('add_monthly.php');
					</script>
				<?php
				}
				else
